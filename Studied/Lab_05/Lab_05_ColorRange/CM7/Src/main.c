...
int main(void)
{
  ...
  */
  ...
  while (1)
  {
    ...
    uwBlueFrequency = RGB_Get_Freq();

    printf("R = %ld G = %ld B = %ld\r\n", uwRedFrequency, uwGreenFrequency, uwBlueFrequency);
  }
}
