...
int main(void)
{
 ...
 /* When system initialization is finished, Cortex-M7 will release Cortex-M4  by means of
  ...
  /***************************/
  /* LL-инициализация GPIO - вариант 1 (прямая запись в регистры) */
  /* Set counter mode */
  ...
  /* Set the auto-reload value to have a counter frequency of 2 Hz */
  /* TIM3CLK = HCLK frequency / (APB prescaler & multiplier)               */
  TimOutClock = hclk_clock_frequency/1;
  LL_TIM_SetAutoReload(TIM3, __LL_TIM_CALC_ARR(TimOutClock, LL_TIM_GetPrescaler(TIM3), 2));

  /* LL-инициализация GPIO - вариант 2 (через структуру инициализации) */
...
//  tim_initstruct.Autoreload        = __LL_TIM_CALC_ARR(TimOutClock, tim_initstruct.Prescaler, 2);
