...
void USART_CharReception_Callback(void)
{
  ...
  received_char = LL_USART_ReceiveData8(UartHandle.Instance);

  LED_Toggle();

  /* Echo received character on TX */
  LL_USART_TransmitData8(UartHandle.Instance, received_char);
}
...
void Error_Callback(void)
{
  ...
  */
  isr_reg = LL_USART_ReadReg(UartHandle.Instance, ISR);
